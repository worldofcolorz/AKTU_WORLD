      ...
      years: [
        {
          ...
          name: '1st Year',
          subjects: [
            { id: 'ai_for_engineering', name: 'AI for Engineering', papers: [{ year: '2022', link: 'https://drive.google.com/file/d/1aVI1RZAjVnN5QcWVxoz5jK0rnnS2Rb9_/view?usp=drive_link' },
              { year: '2023', link: '' }] },
            { id: 'basic_electrical_engineering', name: 'Basic of Electrical Engineering', papers: [{ year: '2022', link: '' },
              { year: '2023', link: '' }] },
            { id: 'emerging_electronics', name: 'Emerging Domain in Electronics Engineering', papers: [{ year: '2022', link: '' },
              { year: '2023', link: '' }] },
            { id: 'emerging_technology', name: 'Emerging Technology for Engineering', papers: [{ year: '2022', link: '' },
              { year: '2023', link: '' }] },
            { id: 'engineering_chemistry', name: 'Engineering Chemistry', papers: [{ year: '2022', link: '' },
              { year: '2023', link: '' }] },
